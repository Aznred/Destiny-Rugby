...
class Protection extends Component<{children:ReactNode},{erreur:boolean}> {
  ...
  render(){return this.state.erreur ? <p className="bp3-erreur">La scène 3D est indisponible. Les flèches du clavier permettent de choisir un pack, puis une pression sur Entrée de l’acheter.</p> : this.props.children;}
}
