...
export default function BoutiquePacks3D({packs,solde,occupe,onOuvrir,gratuit=false,paiementAlternatif}: {packs:PackCarriere[];solde:number;occupe:boolean;onOuvrir:(id:string,nom:string)=>Promise<void>;gratuit?:boolean;paiementAlternatif?:ReactNode}) {
