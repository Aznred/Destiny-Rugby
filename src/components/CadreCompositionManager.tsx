...
function CompositionPleinEcran({ children, fermer }: { children: ReactNode; fermer: () => void }) {
  ...
  return createPortal(<div ref={overlayRef} className="cel-fullscreen-compo">
    <div ref={dialogRef} role="dialog" aria-modal="true" aria-label="Composition de lՎquipe" tabIndex={-1} className="cel-compo cel-compo-etendue manager-compo-partagee">
