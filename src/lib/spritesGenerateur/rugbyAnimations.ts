...
function buildLibrary():AnimationClip[]{
  const clips:AnimationClip[]=[
    ...
    action('trophy_lift','Victoire — coupe soulevée','Célébrations','Les deux bras se lèvent ensemble pour soulever le trophée.',[stance({arms:[-75,0,-105,0]}),stance({y:-18,arms:[-95,0,-85,0],legs:[110,-30,70,30]}),stance({y:-10,arms:[-88,0,-92,0]}),stance({arms:[-75,0,-105,0]})],1.8,true),
