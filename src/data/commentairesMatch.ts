...
export const POOLS_COMMENTAIRES: Record<Exclude<Langue, 'fr'>, Pools> = {
  en: {
    ...
    motif: ['offside', 'high tackle', 'not releasing', 'tackler not rolling away', 'side entry at the ruck', 'scrum infringement', 'obstruction', 'punch', 'mass brawl', 'foul play', 'punch spotted on the footage', 'offside at the ruck', 'support player diving into the ruck', 'collapsed scrum', 'collapsed maul', 'tackle off the ball'],
  ...
  es: {
    ...
    motif: ['fuera de juego', 'placaje alto', 'balón retenido en el suelo', 'el placador no se aparta', 'entrada lateral al ruck', 'falta técnica en melé', 'obstrucción', 'puñetazo', 'tangana general', 'juego sucio', 'puñetazo detectado en las imágenes', 'fuera de juego en el ruck', 'apoyo que se lanza al ruck', 'melé derrumbada', 'maul derrumbado', 'placaje sin balón'],
  ...
  it: {
    ...
    motif: ['fuorigioco', 'placcaggio alto', 'pallone trattenuto a terra', 'placcatore che non si sposta', 'ingresso laterale nel ruck', 'fallo tecnico in mischia', 'ostruzione', 'pugno', 'rissa generale', 'gioco scorretto', 'pugno individuato dalle immagini', 'fuorigioco nel ruck', 'sostegno che si tuffa nel ruck', 'mischia crollata', 'maul crollato', 'placcaggio senza palla'],
  ...
  de: {
    ...
    motif: ['Abseits', 'hohes Tackle', 'Ball am Boden nicht freigegeben', 'Tackler rollt nicht weg', 'seitlicher Eintritt ins Ruck', 'technischer Fehler im Gedränge', 'Behinderung', 'Faustschlag', 'Massenschlägerei', 'unfaires Spiel', 'auf dem Video entdeckter Faustschlag', 'Abseits am Ruck', 'Unterstützer springt ins Ruck', 'eingestürztes Gedränge', 'eingestürztes Maul', 'Tackle ohne Ball'],
  ...
  pt: {
    ...
    motif: ['fora de jogo', 'placagem alta', 'bola retida no chão', 'placador não se afasta', 'entrada lateral no ruck', 'falta técnica na formação ordenada', 'obstrução', 'murro', 'rixa geral', 'jogo desleal', 'murro detetado nas imagens', 'fora de jogo no ruck', 'apoio mergulha no ruck', 'formação ordenada colapsada', 'maul colapsado', 'placagem sem bola'],
  ...
  ja: {
    ...
    motif: ['オフサイド', 'ハイタックル', 'ノットリリース', 'タックラーが退かない', 'ラックへの横入り', 'スクラムでの反則', 'オブストラクション', 'パンチ', '乱闘', 'ラフプレー', '映像で確認されたパンチ', 'ラックでのオフサイド', 'サポート選手のラックへの飛び込み', 'スクラム崩壊', 'モール崩壊', 'ノーボールタックル'],
