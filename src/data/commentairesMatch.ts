...
export const COMMENTAIRES_DIRECTS: Record<Langue, Directs> = {
  ...
  pt: {
    ...
    actionSprint: '{nom} dá uma acelerada!', crochetReussi: 'Finta de {nom}! {cible} placa o vazio.', crochetRate: '{nom} tenta a finta, {cible} não se deixa enganar.', raffutReussi: 'Afastamento de {nom}! Atravessa a placagem.', appelBallon: '{nom} pede a bola em voz alta.', plaquageLance: '{nom} atira-se a {cible}!', plaquageRateJoueur: '{nom} falha e {cible} escapa-se pelas costas.', grattagePlonge: '{nom} mergulha sobre a bola no chão…', provocation: '{nom} provoca {cible}. O ambiente aquece.', provocationIgnoree: '{cible} nem levanta a cabeça.', bagarreDebut: '💢 Descamba: {nom} e {cible} vão às mãos.', bagarreGenerale: 'Os dois packs entram na confusão, o árbitro está ultrapassado.', bagarreSeparee: '{nom} separa toda a gente e afasta os seus.', bagarreRecul: '{nom} levanta as mãos e afasta-se.', coupPorte: '{nom} dá um murro em {cible}!', arbitreVideo: 'O árbitro pede as imagens. Todos esperam.',
  },
  ja: {
