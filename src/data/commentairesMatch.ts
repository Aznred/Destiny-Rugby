...
export const POOLS_COMMENTAIRES: Record<Exclude<Langue, 'fr'>, Pools> = {
  en: {
    ...
    motif: ['offside', 'high tackle', 'not releasing', 'tackler not rolling away', 'side entry at the ruck', 'scrum infringement', 'obstruction'],
  ...
  es: {
    ...
    motif: ['fuera de juego', 'placaje alto', 'balón retenido en el suelo', 'el placador no se aparta', 'entrada lateral al ruck', 'falta técnica en melé', 'obstrucción'],
  ...
  it: {
    ...
    motif: ['fuorigioco', 'placcaggio alto', 'pallone trattenuto a terra', 'placcatore che non si sposta', 'ingresso laterale nel ruck', 'fallo tecnico in mischia', 'ostruzione'],
  ...
  de: {
    ...
    motif: ['Abseits', 'hohes Tackle', 'Ball am Boden nicht freigegeben', 'Tackler rollt nicht weg', 'seitlicher Eintritt ins Ruck', 'technischer Fehler im Gedränge', 'Behinderung'],
  ...
  pt: {
    ...
    motif: ['fora de jogo', 'placagem alta', 'bola retida no chão', 'placador não se afasta', 'entrada lateral no ruck', 'falta técnica na formação ordenada', 'obstrução'],
  ...
  ja: {
    ...
    motif: ['オフサイド', 'ハイタックル', 'ノットリリース', 'タックラーが退かない', 'ラックへの横入り', 'スクラムでの反則', 'オブストラクション'],
