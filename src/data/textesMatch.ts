...
export const TEXTES_MATCH: Record<string, Traduction> = {
  ...
  // ═══ LE SOUFFLE ═════════════════════════════════════════════════════════
  'ml.sprintEnCours': { fr: 'SPRINT', en: 'SPRINT', es: 'SPRINT', it: 'SCATTO', de: 'SPRINT', pt: 'SPRINT', ja: 'スプリント' },

  // ═══ LES TOUCHES RÉGLABLES (composants/ReglageTouches.tsx) ══════════════
  'cmd.haut': { fr: 'Avancer', en: 'Forward', es: 'Avanzar', it: 'Avanti', de: 'Vorwärts', pt: 'Avançar', ja: '前進' },
  'cmd.bas': { fr: 'Reculer', en: 'Backward', es: 'Retroceder', it: 'Indietro', de: 'Rückwärts', pt: 'Recuar', ja: '後退' },
  'cmd.gauche': { fr: 'Aller à gauche', en: 'Move left', es: 'Ir a la izquierda', it: 'Andare a sinistra', de: 'Nach links', pt: 'Ir para a esquerda', ja: '左へ移動' },
  'cmd.droite': { fr: 'Aller à droite', en: 'Move right', es: 'Ir a la derecha', it: 'Andare a destra', de: 'Nach rechts', pt: 'Ir para a direita', ja: '右へ移動' },
  'cmd.sprint': { fr: 'Sprinter (maintenu)', en: 'Sprint (hold)', es: 'Esprintar (mantener)', it: 'Scattare (tenere premuto)', de: 'Sprinten (halten)', pt: 'Sprintar (manter)', ja: 'スプリント（長押し）' },
  'cmd.principale': { fr: 'Action du moment', en: 'Action of the moment', es: 'Acción del momento', it: 'Azione del momento', de: 'Aktion des Moments', pt: 'Ação do momento', ja: 'その場のアクション' },

  'reg.touches': { fr: 'Touches du match', en: 'Match controls', es: 'Controles del partido', it: 'Comandi di gioco', de: 'Spielsteuerung', pt: 'Comandos do jogo', ja: '試合の操作キー' },
  'reg.touchesAide': { fr: 'Clique sur une touche puis appuie sur celle que tu veux, clavier ou bouton de souris. Échap annule, Suppr remet la touche d’origine. Une touche ne peut servir qu’à une seule action.', en: 'Click a key, then press the one you want, keyboard or mouse button. Esc cancels, Delete restores the default. A key can only serve one action.', es: 'Haz clic en una tecla y luego pulsa la que quieras, teclado o botón del ratón. Esc cancela, Supr restaura la original. Una tecla solo puede servir para una acción.', it: 'Clicca su un tasto e poi premi quello che vuoi, tastiera o pulsante del mouse. Esc annulla, Canc ripristina l’originale. Un tasto può servire a una sola azione.', de: 'Klicke auf eine Taste und drücke dann die gewünschte, Tastatur oder Maustaste. Esc bricht ab, Entf stellt die Standardtaste wieder her. Eine Taste kann nur eine Aktion belegen.', pt: 'Clica numa tecla e depois carrega na que queres, teclado ou botão do rato. Esc cancela, Del repõe a original. Uma tecla só pode servir uma ação.', ja: 'キーをクリックしてから、割り当てたいキー（キーボードまたはマウスボタン）を押す。Escで取り消し、Deleteで初期設定に戻す。1つのキーは1つの操作にのみ使える。' },
  'reg.touchesEcoute': { fr: 'Appuie…', en: 'Press…', es: 'Pulsa…', it: 'Premi…', de: 'Drücke …', pt: 'Carrega…', ja: '入力待ち…' },
  'reg.touchesDefaut': { fr: 'Tout remettre par défaut', en: 'Reset everything', es: 'Restablecer todo', it: 'Ripristina tutto', de: 'Alles zurücksetzen', pt: 'Repor tudo', ja: 'すべて初期設定に戻す' },
  'reg.touchesAssigner': { fr: 'Changer la touche de « {commande} »', en: 'Change the key for “{commande}”', es: 'Cambiar la tecla de «{commande}»', it: 'Cambiare il tasto di «{commande}»', de: 'Taste für „{commande}“ ändern', pt: 'Mudar a tecla de «{commande}»', ja: '「{commande}」のキーを変更' },
