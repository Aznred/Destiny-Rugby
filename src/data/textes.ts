...
const ECRIT_A_LA_MAIN: Record<string, Traduction> = {
  ...
  'ia.erreurWebGPU': { fr: 'IA locale indisponible : ce navigateur ne prend pas en charge WebGPU.', en: 'Local AI is unavailable: this browser does not support WebGPU.', es: 'La IA local no está disponible: este navegador no admite WebGPU.', it: 'IA locale non disponibile: questo browser non supporta WebGPU.', de: 'Lokale KI nicht verfügbar: Dieser Browser unterstützt WebGPU nicht.', pt: 'IA local indisponível: este navegador não suporta WebGPU.', ja: 'ローカルAIは利用できません。このブラウザーはWebGPUに対応していません。' },
  'ia.erreurChargementGpu': { fr: 'Le processeur graphique de cet appareil ne peut pas charger le modèle local.', en: 'This device’s graphics processor cannot load the local model.', es: 'El procesador gráfico de este dispositivo no puede cargar el modelo local.', it: 'Il processore grafico di questo dispositivo non può caricare il modello locale.', de: 'Der Grafikprozessor dieses Geräts kann das lokale Modell nicht laden.', pt: 'O processador gráfico deste dispositivo não consegue carregar o modelo local.', ja: 'この端末のGPUではローカルモデルを読み込めません。' },
  'ia.erreurChargementDetail': { fr: 'Impossible de charger l’IA locale : {detail}', en: 'The local AI could not be loaded: {detail}', es: 'No se pudo cargar la IA local: {detail}', it: 'Impossibile caricare l’IA locale: {detail}', de: 'Die lokale KI konnte nicht geladen werden: {detail}', pt: 'Não foi possível carregar a IA local: {detail}', ja: 'ローカルAIを読み込めませんでした: {detail}' },
  'ia.erreurInconnue': { fr: 'erreur inconnue', en: 'unknown error', es: 'error desconocido', it: 'errore sconosciuto', de: 'unbekannter Fehler', pt: 'erro desconhecido', ja: '不明なエラー' },
  'ia.erreurMemoire': { fr: 'Mémoire graphique insuffisante pour faire répondre l’IA locale.', en: 'There is not enough graphics memory for the local AI to respond.', es: 'No hay suficiente memoria gráfica para que responda la IA local.', it: 'Memoria grafica insufficiente per far rispondere l’IA locale.', de: 'Nicht genügend Grafikspeicher für eine Antwort der lokalen KI.', pt: 'Memória gráfica insuficiente para a IA local responder.', ja: 'ローカルAIの応答に必要なGPUメモリが不足しています。' },
  'ia.erreurGpu': { fr: 'Le processeur graphique a interrompu l’IA locale. Recharge la page puis réessaie.', en: 'The graphics processor stopped the local AI. Reload the page and try again.', es: 'El procesador gráfico interrumpió la IA local. Recarga la página e inténtalo de nuevo.', it: 'Il processore grafico ha interrotto l’IA locale. Ricarica la pagina e riprova.', de: 'Der Grafikprozessor hat die lokale KI angehalten. Lade die Seite neu und versuche es erneut.', pt: 'O processador gráfico interrompeu a IA local. Recarrega a página e tenta novamente.', ja: 'GPUがローカルAIを停止しました。ページを再読み込みしてもう一度お試しください。' },
  'ia.erreurModeleIncomplet': { fr: 'Le modèle local semble incomplet. Supprime-le dans les paramètres puis télécharge-le de nouveau.', en: 'The local model appears incomplete. Delete it in settings, then download it again.', es: 'El modelo local parece incompleto. Bórralo en los ajustes y vuelve a descargarlo.', it: 'Il modello locale sembra incompleto. Eliminalo nelle impostazioni, poi scaricalo di nuovo.', de: 'Das lokale Modell scheint unvollständig zu sein. Lösche es in den Einstellungen und lade es erneut herunter.', pt: 'O modelo local parece incompleto. Apaga-o nas definições e transfere-o novamente.', ja: 'ローカルモデルが不完全です。設定で削除し、再度ダウンロードしてください。' },
  'ia.erreurDetail': { fr: 'L’IA locale n’a pas pu répondre : {detail}', en: 'The local AI could not respond: {detail}', es: 'La IA local no pudo responder: {detail}', it: 'L’IA locale non ha potuto rispondere: {detail}', de: 'Die lokale KI konnte nicht antworten: {detail}', pt: 'A IA local não conseguiu responder: {detail}', ja: 'ローカルAIが応答できませんでした: {detail}' },
  'ia.erreurGenerique': { fr: 'L’IA locale n’a pas pu répondre. Recharge la page puis réessaie.', en: 'The local AI could not respond. Reload the page and try again.', es: 'La IA local no pudo responder. Recarga la página e inténtalo de nuevo.', it: 'L’IA locale non ha potuto rispondere. Ricarica la pagina e riprova.', de: 'Die lokale KI konnte nicht antworten. Lade die Seite neu und versuche es erneut.', pt: 'A IA local não conseguiu responder. Recarrega a página e tenta novamente.', ja: 'ローカルAIが応答できませんでした。ページを再読み込みしてもう一度お試しください。' },
