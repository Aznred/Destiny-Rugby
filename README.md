...
| **« Refais la mécanique de match totalement »** | Le terrain 2D, la caméra et le joystick sont remplacés par un **fil de match** : des blocs de 2 à 4 actions, une ligne par évènement (`12′ 💥 Gros plaquage`), ta ligne surlignée, une barre qui montre où est le ballon, et la même carte de décision à dix secondes. Il n'y a plus rien à apprendre pour jouer, et ça marche à l'identique sur n'importe quel appareil. **3,6 min par match.** ⚠️ Le moteur, lui, n'a pas bougé : le score reste exactement celui de la ligue. |
